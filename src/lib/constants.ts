...
export const DEV_TICKERS: TickerConfig[] = [
  ...
  { symbol: "JPM", name: "JPMorgan Chase & Co.", sector: "Financials", industry: "Banks—Diversified" },
...
export const FULL_SP500_TICKERS: { symbol: string; name: string; sector: Sector }[] = [
  // Technology
  ...
  { symbol: "CFG", name: "Citizens Financial Group Inc.", sector: "Financials" },
  ...
  { symbol: "EL", name: "The Estée Lauder Companies", sector: "Consumer Staples" },
  { symbol: "K", name: "Kellanova", sector: "Consumer Staples" },
  { symbol: "CHD", name: "Church & Dwight Co. Inc.", sector: "Consumer Staples" },
  { symbol: "MKC", name: "McCormick & Company Inc.", sector: "Consumer Staples" },
